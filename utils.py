...
#drop_duplicates -> Remove os itens duplicados da coluna Local da compra
...
df_rec_mensal = df.set_index('Data da Compra').groupby(pd.Grouper(freq='MS'))['Preço'].sum().reset_index()
# Indexado pela Data da Compra
# Agrupado por mês
# Somatória da coluna Preço.
