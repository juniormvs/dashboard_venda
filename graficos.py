...
grafico_rec_estado = px.bar(
    # df_rec_estado.head(),#pega os cinco primeiros registros
    # df_rec_estado.tail(),#pega os cinto últimos registros
    df_rec_estado.head(7),#pega os sete primeiros registros
    x='Local da compra',
    y='Preço',
    text_auto=True,
...
#Gráfico contagem de vendas por vendedor
